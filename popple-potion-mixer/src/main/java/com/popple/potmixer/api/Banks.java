package com.popple.potmixer.api;
...
public class Banks {
    public static final int[] ALL_BANKS = {
            ObjectID.BANK,
            ObjectID.BANK_BOX,
            ObjectID.BANK_BOOTH,
            ObjectID.BANK_CHEST,
    ...
    public static TileObject findNearest() {
//        for (int bankID : ALL_BANKS) {
//            TileObject bank = TileObjects.getNearest(bankID);
//            if (bank != null) return bank;
//        }

        return TileObjects.getNearest(ALL_BANKS);
    }
}
